...
def material_detail(request, id):
    ...
    return render(request, 'cost/material_detail.html',
                  {'material': material,
...
def detail_detail(request, id):
    ...
    return render(request, 'cost/detail_detail.html',
                  {'detail': detail,
...
def assembly_detail(request, id):
    ...
    return render(request, 'cost/assembly_detail.html',
                  {'assembly': assembly,
...
def product_detail(request, id):
    ...
    return render(request, 'cost/product_detail.html',
                  {'product': product,
...
def mp_detail(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, 'cost/mp_detail.html',
                      {'mp': mp,
